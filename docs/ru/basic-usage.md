...
1) Настройка драйверов социальных сетей в конфигурации приложения
```php
'components' => [
    // ...
    'socialShare' => [
...
#### Если вы хотите использовать все возможности - прочтите [продвинутуе использование](https://github.com/yiimaker/yii2-social-share/blob/master/docs/en/advanced-usage.md)